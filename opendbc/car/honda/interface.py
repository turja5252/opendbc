...
class CarInterface(CarInterfaceBase):
  ...
  def _get_params(ret: structs.CarParams, candidate, fingerprint, car_fw, alpha_long, is_release, docs) -> structs.CarParams:
    ...
    if candidate == CAR.HONDA_CIVIC:
      ...
      ret.lateralParams.torqueBP, ret.lateralParams.torqueV = [[0, 4350], [0, 4350]]  # TODO: to determine if there is a dead zone at the top end ret.lateralParams.torqueBP, ret.lateralParams.torqueV = [[0, 4096], [0, 4096]]
